...
fun createModuleResolverProvider(
    ...
    val builtIns = providedBuiltIns ?: createBuiltIns(facadeKey, globalContext)
    ...
    fun createResolverForProject(): ResolverForProject<IdeaModuleInfo> {
        ...
        return AnalyzerFacade.setupResolverForProject(
                ...
                { module -> AnalyzerFacadeProvider.getAnalyzerFacade(module.platform ?: facadeKey.platform) },
                ...
                facadeKey.sdk?.let { SdkInfo(project, it) },
    ...
    if (providedBuiltIns == null && builtIns is JvmBuiltIns) {
        // TODO: some clever explanation why this isn't null...
        val sdkModuleDescriptor = facadeKey.sdk!!.let { resolverForProject.descriptorForModule(SdkInfo(project, it)) }
        builtIns.initialize(sdkModuleDescriptor, facadeKey.isAdditionalBuiltInFeaturesSupported)
    }
...
private fun createBuiltIns(facadeKey: FacadeKey, sdkContext: GlobalContextImpl): KotlinBuiltIns = when {
    facadeKey.platform is JsPlatform -> JsPlatform.builtIns
    facadeKey.platform is JvmPlatform && facadeKey.sdk != null -> JvmBuiltIns(sdkContext.storageManager)
